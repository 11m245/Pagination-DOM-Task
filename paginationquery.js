...
function displayNavButton(indexcount){
    ...
    heading.innerText="Bootsrap Table and Pagination"; 
    document.body.append(heading);


    var descriptionpEl=document.createElement("p");
    descriptionpEl.innerHTML="using xmlhttp and bootstrap for table using dom";
    descriptionpEl.setAttribute("id","description");
    descriptionpEl.setAttribute("class","text-center");
    document.body.append(descriptionpEl);
